...
python generate_dataset.py --dataset_path './data/data.csv' --delta_path delta_trial.txt --checkpoint_path checkpoints/_netG_epoch_1499.pth --output_path './Results/prova.npy' 
